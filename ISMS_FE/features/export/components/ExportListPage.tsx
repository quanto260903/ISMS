// ============================================================
//  features/export/components/ExportListPage.tsx
// ============================================================
    ...
    <div style={s.page}>
      ...
      <div style={s.heroBanner}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={s.heroEyebrow}>WMS Pro · Quản lý xuất kho</div>
          <h1 style={s.heroTitle}>Danh sách phiếu xuất kho</h1>
          <p style={s.heroSub}>Quản lý toàn bộ phiếu xuất, tra cứu và theo dõi tình trạng hàng hóa</p>
        </div>
        <button style={s.btnPrimary} onClick={() => router.push("/dashboard/export/new")}>
...
function ExportRow({ row, i, onEdit }: { row: ExportListItem; i: number; onEdit: () => void }) {
  ...
  return (
    ...
    >
      ...
      <td style={{ ...s.td, textAlign: "right", fontWeight: 700, color: "#0f766e" }}>
...
const s: Record<string, React.CSSProperties> = {
  ...
  grandTotalAmount: { fontSize: 17, fontWeight: 800, color: "#0f766e", letterSpacing: "-0.3px" },
