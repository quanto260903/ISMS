...
import { uploadFile } from '@/services/api/cloudinary.api'
...
export default function NewProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.serialNumber || !formData.name || !formData.expiredDate || !formData.receivedDate) {
      toast({
        variant: 'destructive',
        title: 'Lỗi',
    ...
    try {
      ...
      // Step 1: Upload ảnh lên Cloudinary nếu có
      if (imageFile) {
        setIsUploading(true)
      ...
      // Step 2: Tạo sản phẩm với URL ảnh
      ...
      if (response.isSuccess) {
        toast({
          title: 'Thành công',
          description: response.message || 'Tạo sản phẩm thành công',
        })
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Thêm sản phẩm vào kho</p>
        </div>
      </div>
          ...
          <CardContent className="space-y-4">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-500 transition-colors">
                      ...
                      >
                        ...
                        <div className="text-sm">
                          <span className="text-purple-600 font-medium">Chọn file ảnh</span>
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <Button type="submit" disabled={isLoading || isUploading}>
                {isUploading ? 'Đang upload ảnh...' : isLoading ? 'Đang tạo...' : 'Tạo sản phẩm'}
              </Button>
            </div>
          </CardContent>
        </Card>
